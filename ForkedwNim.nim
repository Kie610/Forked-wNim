#====================================================================
#
#               ForkedwNim - Nim's Windows GUI Framework
#                (c) Copyright 2017-2021 Ward
#
#====================================================================

##  ForkedwNim is Nim's Windows GUI framework.
##
##  Reference
##  =========
##
...
when not defined(Nimdoc):
  import
    ForkedwNim/private/[wTypes, wMacros, wApp, wAcceleratorTable, wDataObject, wPrintData,
      wIconImage, wImage, wImageList, wEvent, wResizable, wResizer, wWindow,
      wPanel, wFrame, wToolTip, wUtils, autolayout],

    ForkedwNim/private/gdiobjects/[wBitmap, wBrush, wCursor, wFont, wGdiObject, wIcon, wPen, wRegion],

    ForkedwNim/private/dc/[wDC, wClientDC, wMemoryDC, wPaintDC, wPrinterDC, wScreenDC, wWindowDC],

    ForkedwNim/private/menu/[wMenu, wMenuBar, wMenuBase, wMenuItem],

    ForkedwNim/private/controls/[wControl, wButton, wCalendarCtrl, wCheckBox, wCheckComboBox,
    ...
    ForkedwNim/private/dialogs/[wColorDialog, wDialog, wDirDialog, wFileDialog, wFindReplaceDialog,
      wFontDialog, wMessageDialog, wPageSetupDialog, wPasswordEntryDialog,
      wPrintDialog, wTextEntryDialog],

    ForkedwNim/private/consts/[wColors, wKeyCodes],

    ForkedwNim/private/controls/wImgStaticText
